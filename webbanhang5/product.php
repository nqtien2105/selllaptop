...
<div id="page-content" class="single-page">
   ...
   LEFT JOIN nhaxuatban n on n.ID = s.Manhasx
	...
	if (isset($_POST['submit'])) {
		...
		echo "<script>window.location.replace('http://localhost:80/webbanhang5/cart.php'); </script>";
	}
			...
			<div id="main-content" class="col-md-8">
				<div class="product">
					...
					<div class="col-md-6">
						<div class="caption">
							...
							<div class="info">
								<ul>
									<li>Ram: <b><?php echo $row["tacgia"] ?></b></li>
									<li>Thương Hiệu: <a href="/category.php?manhasx=<?php echo $row["Manhasx"] ?>"><?php echo $row["Tennhasx"] ?></a>
										<h3>
									</li>
								</ul>
							</div>
								...
								<div class="modal-dialog">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<p>Chức năng mua ngay giúp bạn mua nhanh mà không cần đăng nhập hoặc đặt hàng với một thông tin khác với thông tin trên tài khoản. Tuy nhiên bạn chỉ có thể mua một loại laptop trong một lần đặt hàng, bạn nên đăng nhập để không phải nhập lại thông tin cũng như mua nhiều loại laptop cùng lúc.</p>
				...
				<div class="product-desc">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#description">Thông tin laptop</a></li>
					</ul>
