	...
	<div class="container">
		...
		<div class="cart">
			<p><?php
				...
				if ($ok == 2) {
					echo "Có " . count($_SESSION['cart']) . " Laptop trong giỏ hàng ";
				} else {
					echo   "<p>Không có có laptop nào trong giỏ hàng</p>";
				}
		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-8 ">
				<center><a href="index.php" class="btn btn-1" style="margin-left:-76px">Chọn những laptop khác</a></center>
			</div>
			<div class="row">
